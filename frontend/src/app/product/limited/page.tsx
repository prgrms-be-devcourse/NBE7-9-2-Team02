...
export default function LimitedProductListPage() {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const mockProducts: Product[] = Array.from({ length: 20 }, (_, i) => ({
        ...
        category: ['TOP', 'BOTTOM', 'OUTERWEAR', 'BAG', 'ETC'][Math.floor(Math.random() * 5)],
        isFree: false,
        isLimited: true,
      }));
  ...
  const updateURL = (params: { sort?: ProductSortType; page?: number }) => {
    ...
    router.push(`/product/limited?${newSearchParams.toString()}`);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div>
            ...
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold">한정판매 상품</h2>
